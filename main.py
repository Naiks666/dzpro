...
# Виджет таблицы главного окна
        
        # Создание таблицы
        self.tree = ttk.Treeview(self, columns=('id', 'name', 'salary', 'phone', 'email'), 
                                                height=45, show='headings')
        # Добавить параметры колонкам
        self.tree.column('id', width=45, anchor=tk.CENTER)
        self.tree.column('name', width=272, anchor=tk.CENTER)
...
# Основные методы
    ...
    # Метод для отображения данных в TreeView
    def view_records(self):
        ...
        # Добавляем в таблицу все данные из ДБ
...
# Вызовы классов
    ...
    # Метод отвечающий за вызов окна поиск
...
class DB:
    ...
    def insert_data (self, name, phone, email, salary):
        self.cur.execute("""
                        INSERT INTO users (name, salary, phone, email)
                        VALUES(?, ?, ?, ?)""", (name, salary, phone, email))
        self.conn.commit()
